...
export const APP_SHELL_CLASS =
  'app-shell min-h-dvh bg-bg flex w-full min-w-0 max-w-full overflow-x-clip'

export const MAIN_CONTENT_CLASS =
  'main-content transition-all duration-300'

export const PAGE_CONTAINER_CLASS =
  'page-container mx-auto w-full min-w-0 max-w-[1400px] overflow-x-clip px-[var(--page-px)] py-[var(--page-py)] pb-[calc(var(--page-py)+var(--bottom-nav-height)+env(safe-area-inset-bottom,0px))] lg:pb-[var(--page-py)]'

export const MAIN_SCROLL_CLASS =
  'flex-1 min-h-0 min-w-0 w-full overflow-y-auto overflow-x-clip scrollbar-thin pb-[calc(var(--bottom-nav-height)+env(safe-area-inset-bottom,0px))] lg:pb-0'
